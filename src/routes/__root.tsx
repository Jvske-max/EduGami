...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "EVEA híbrido que fusiona gestión académica con micro-aprendizaje gamificado. Universidad Alejandro de Humboldt." },
      { name: "author", content: "Fernando Silva, Isaac" },
      { property: "og:title", content: "EduGami — LMS Gamificado" },
